    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          className={twMerge(
            clsx(
              "w-full px-3.5 py-2 text-sm rounded-lg bg-[#0d1320] border text-slate-100 placeholder:text-slate-500 transition-colors focus:outline-none focus:ring-1 resize-y",
              error
